...
const SignUp: React.FC = () => {
  ...
  <h1><b><b><b>One-Stop-Shop</b></b></b></h1>
</Link>
</div>
                    </Link>
              <p className="2xl:px-20">
                Don't have an account? Fill in your credentials to be an administrator of the One-Stop-Shop
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <center><h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to One-Stop-Shop
              </h2></center>
